...
var responseInterface = module.exports = function (host, request, response) {
	'use strict';
...
responseInterface.prototype.render = function (source, imports) {
	'use strict';
	...
	var data = this.host.tengine(path.join(this.host.tprefix, source), imports);
