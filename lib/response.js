...
responseInterface.prototype.render = function () {
	'use strict';
	var data = this.server.render.apply(null, arguments);
	this.stream.end(data);
};
...
// Make public the mime types as an object
var mimeTypes = module.exports.mimeTypes = JSON.parse(fs.readFileSync(__dirname + '/../utils/mime.json', 'utf8'));